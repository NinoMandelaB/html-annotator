...
def convert_annotated_html_to_pdf(html_content, annotations):
    ...
    CRITICAL:
    Do NOT use inject_visual_annotations() for PDF generation! That function creates complex
    CSS that xhtml2pdf cannot parse. Instead, we apply MINIMAL inline styles directly to
    annotated elements.
